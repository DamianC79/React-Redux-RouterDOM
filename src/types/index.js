...
export const OBTENER_PRODUCTO_ELIMINADO = 'OBTENER_PRODUCTO_ELIMINADO';
...
export const OBTENER_EDITADO_EXITO = 'OBTENER_EDITADO_EXITO';
export const OBTENER_EDITADO_ERROR = 'OBTENER_EDITADO_ERROR';
